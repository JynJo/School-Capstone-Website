    ...
    return (
        <>
            {Object.keys(errors).length > 0 && (
                <div
                    role="alert"
                    className="rounded border-s-4 border-red-400 bg-red-100 p-4 mb-4"
                >
            ...
            {flash.success && (
                <div
                    role="alert"
                    className="rounded border-s-4 border-green-500 bg-green-200 p-4 mb-4"
                >
                    <strong className="block font-bold text-green-800">
                        {" "}
                        Success!{" "}
                    </strong>
                            ...
                            subjects.map((subject) => (
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            value={
                                                data.subjectAverage[subject.id]
                                            }
                                            onChange={(e) =>
                                                handleSubjectAverageChange(
                                                    subject.id,
                                                    e.target.value
                                                )
                                            }
