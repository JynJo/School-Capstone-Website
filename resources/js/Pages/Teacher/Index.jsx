...
const Index = ({ teacher }) => {
	...
	return (
		...
		<table className="w-full table-auto min-w-max border table-bordered table-striped">
			...
			<tbody>
					<tr>
						<td className="p-4"><p className="font-light">{ section && section.name }</p></td>
						<td className="p-4"><p className="font-light">TVL</p></td>
						<td className="p-4"><p className="font-light">2024-2025</p></td>
						<td className="p-4"><p className="font-light">12</p></td>
						<td className="p-4"><p className="font-light">First Semester</p></td>
					</tr>
			</tbody>
		</table>
		</>
