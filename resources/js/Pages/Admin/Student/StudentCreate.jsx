    ...
    <div className="mx-auto">
      <div className="bg-white p-6">
        ...
        <p className="text-gray-500  mb-6 text-sm">
          Please use student's lccdo account for email address.
        </p>
        <form onSubmit={submitHandler}>
          ...
          <div>
            ...
            <input
              ...
              className="border p-2 rounded w-full"
            />
		      { errors.id_number && <p className="text-danger text-sm ">{ errors.id_number }</p>}
            </div>
          </div>
          <div className="mb-4">
            <input
          ...
          <div className="mb-4">
		      ...
		      { errors.section_id && <p className="text-danger text-sm ">{ errors.section_id }</p>}
          </div>
          <div className="mb-4">
            <input
              type="text"
          ...
          <div>
		      ...
		      { errors.blood_type && <p className="text-danger text-sm ">{ errors.blood_type }</p>}
          </div>
          <div>
          ...
          <div>
              ...
              className="border p-2 rounded w-full"
            />
		      { errors.parent_no && <p className="text-danger text-sm ">{ errors.parent_no }</p>}
          </div>
            <div>
	            ...
	            <input
		     	...
		     	onChange={e => setData('birthday', e.target.value)}
	              ...
	              className="border p-2 rounded w-full"
	            />
		      { errors.birthday && <p className="text-danger text-sm ">{ errors.birthday }</p>}
            </div>
