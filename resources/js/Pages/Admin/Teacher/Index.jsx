        ...
        <>
            <div className="p-4">
                ...
                <Link
                    ...
                    className="font-light p-2 btn btn-dark m-4 text-uppercase"
                >
                    Add new teacher
                </Link>
                <Link
                    href={route("teacher-section.create")}
                    className="font-light p-1 btn btn-dark m-4 text-uppercase"
                >
                    Assign teacher to advisory
                </Link>
                <table>
                            ...
                            teachers.data.map((teacher, index) => (
                                <>
                                    <tr className="hover:bg-gray-100">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800  text-capitalize">
                                            {teacher.gender}
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 ">
                                            {teacher.address}
                ...
                <div className="flex justify-between mt-4">
                    <div className="text-sm text-slate-500">
                        Showing <b>{teachers && teachers.current_page}</b> of{" "}
                        {teachers && teachers.total}
                    </div>
                    <div>
                        {teachers &&
                            teachers.links.map((link) =>
                                link.url ? (
                                    <Link
                                        href={link.url}
                                        className={`${
