...
export default function TeacherEdit({ teacher }) {
	...
	put( route('teacher.update', { id: teacher.id }) );
	}
      ...
      <div className="bg-white p-6">
        ...
        <form onSubmit={submitHandler}>
          ...
          <div>
              ...
              className="border p-2 rounded w-full"
            />
		      { errors.phone_number && <p className="text-danger text-sm ">{ errors.phone_number }</p>}
          </div>
            <div>
...
TeacherEdit.layout = page => <DashboardLayout children={page}/>