        ...
        <>
            ...
            >
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {/* Card */}
                    {news.map((news, index) => (
                        <div className="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition max-h-[500px]">
                            ...
                            <Link
                                ...
                                className="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold text-[#ea9999]"
                            >
                                Read More
                                <svg
