...
export default function AboutSection() {
    return (<>
        <div className="lg:text-center">
            <h2 className="text-pink-600 text-center text-3xl my-4 font-semibold" style={{ fontFamily: 'Poppins' }}>
                About Us
            </h2>
        </div>
        <div data-aos="fade-down" className="py-12 bg-[url(/images/about-img.jpg)] bg-linear-to-r from-gray-500 to-gray-500">
