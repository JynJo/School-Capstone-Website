        ...
        <div className="mx-auto flex h-20 max-w-screen-xl items-center justify-between px-4 sm:px-6 lg:px-8">
            <div className="flex-grow">
                <Link className="flex flex-row items-center gap-4" href={route('home')}>
                    ...
                    <h2 className="text-xl hidden md:block text-[#ea9999] font-semibold" style={{ fontFamily: "Raleway", width: '100px', textWrap: 'wrap' }}>
                        Lourdes College
                    </h2>
                </Link>
            ...
            <div className="flex flex-1 justify-center">
                <nav aria-label="Global" className={`${isMobileMenuOpen ? 'active' : ''}`}>
                    <ul className="flex items-center text-center gap-8" style={{ fontFamily: 'Poppins' }}>
                        <li>
                            <Link className="hover:text-[#ea9999] text-md font-light text-[#272828] transition" href={route('home')}>
                                Home
                            </Link>
                        </li>
                        <li>
                            <Link className="hover:text-[#ea9999] text-md font-light text-[#272828] transition" href={route('admission.index')}>
                                Academics
                            </Link>
                        </li>
                        <li>
                            <Link className="hover:text-[#ea9999] text-md font-light text-[#272828] transition" href={route('events')}>
                                Events
                            </Link>
                        </li>
                        <li>
