  ...
  return (<>
    ...
    <div className="flex flex-col items-center">
      <div className="flex flex-row items-center gap-5">
        <img src="/images/lc-seal.png" alt="LC SEAL" width="100"/>
          <p className="text-xl font-bold text-pink text-uppercase tracking-wide" style={{ fontFamily: "Faculty Glyphic" }}>Lourdes College</p>
      </div>
      <div className="w-full py-0.5 my-2 bg-pink rounded-xl"></div>
          <p className="text-pink text-lg font-light text-uppercase  tracking-wider" style={{ fontFamily: "Poppins" }}>student portal</p>
    </div>
      <form onSubmit={submitHandler} className="bg-white mt-4 w-1/4">
        ...
        <button className="cursor-pointer rounded hover:opacity-75 bg-pink p-2 w-full block font-medium text-uppercase">Submit</button>
      </div>
      </form>
    </div>
